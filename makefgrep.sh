...
# COPY lines 17 through 33 of the template file to findgrep.sh
...
# COPY lines 34 through 44 of the template file to findgrep.sh
...
# COPY lines 48 through the end of the template file to findgrep.sh
...
rm -f $SHSCRIPT    # REMOVE the old findgrep in BINDIR
